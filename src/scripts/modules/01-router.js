// =========================================================================
// VOCAFLOW SPA ROUTER & URL HISTORY ENGINE (v0.10.10-32 Build 333)
...
function navigateToRoute(route, isPopState = false) {
  ...
  try {
    ...
    if (firstSegment === 'study' && secondSegment) {
      ...
      if ((secondSegment === 'translation' || secondSegment === 'dich' || secondSegment === 'translate') && typeof startTranslationMode === 'function') {
