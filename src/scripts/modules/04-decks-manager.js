...
// VOCAFLOW 04-DECKS-MANAGER.JS (v0.10.10-39 Build 340)
...
4. DEFINITION (definition_vietnamese): Extremely concise Vietnamese meaning (1-4 words). Strictly 1 core meaning. NO commas, NO semicolons, NO ellipses, NO "và", NO "ai, cái gì", NO parentheses. MANDATORY PART-OF-SPEECH ACCURACY: For abstract/action nouns (e.g. withdrawal, development, negotiation), ALWAYS add noun markers like "Sự", "Việc", "Cuộc", "Khoản" (e.g. "Sự rút tiền", "Sự phát triển", "Cuộc đàm phán"); for agent nouns add "Người/Nhà" (e.g. "Nhà khoa học"); for tool nouns add "Máy/Thiết bị/Dụng cụ". For verbs use bare action verbs without "sự" (e.g. "Rút tiền", "Phát triển"). For adverbs use "Một cách..." (e.g. "Một cách cẩn thận"). Supplementary explanations MUST be placed in 'note'. For vulgar/taboo/slang words, write the full explicit Vietnamese vulgar meaning without censorship or abbreviations.
...
4. DEFINITION: Extremely concise Vietnamese meaning (1-4 words). Strictly 1 core meaning. NO commas, NO semicolons, NO ellipses, NO "và", NO "ai, cái gì", NO parentheses. MANDATORY PART-OF-SPEECH ACCURACY: For abstract/action nouns (e.g. withdrawal, development, negotiation), ALWAYS add noun markers like "Sự", "Việc", "Cuộc", "Khoản" (e.g. "Sự rút tiền", "Sự phát triển", "Cuộc đàm phán"); for agent nouns add "Người/Nhà" (e.g. "Nhà khoa học"); for tool nouns add "Máy/Thiết bị/Dụng cụ". For verbs use bare action verbs without "sự" (e.g. "Rút tiền", "Phát triển"). For adverbs use "Một cách..." (e.g. "Một cách cẩn thận"). Supplementary notes go into 'note'. Full uncensored vulgar words if taboo.
...
5. DEFINITION: Extremely concise Vietnamese meaning (1-4 words). Strictly 1 core meaning. NO commas, NO semicolons, NO ellipses, NO "và", NO "ai, cái gì", NO parentheses. MANDATORY PART-OF-SPEECH ACCURACY: For abstract/action nouns (e.g. withdrawal, development, negotiation), ALWAYS add noun markers like "Sự", "Việc", "Cuộc", "Khoản" (e.g. "Sự rút tiền", "Sự phát triển", "Cuộc đàm phán"); for agent nouns add "Người/Nhà" (e.g. "Nhà khoa học"); for tool nouns add "Máy/Thiết bị/Dụng cụ". For verbs use bare action verbs without "sự" (e.g. "Rút tiền", "Phát triển"). For adverbs use "Một cách..." (e.g. "Một cách cẩn thận"). Supplementary notes go into 'note'. Full uncensored vulgar words if taboo.
