...
$zipPath = Join-Path $PSScriptRoot "VocaFlow_v0.10.10-42_Windows_Portable.zip"
$rootZipPath = Join-Path $root "VocaFlow_v0.10.10-42_Windows_Portable.zip"
...
if (Test-Path $releaseDir) {
    ...
    Write-Host "  -> Đã tạo gói: VocaFlow_v0.10.10-42_Windows_Portable.zip" -ForegroundColor Green
}
Write-Host ""
...
& $git -C $root add .
$commitMsg = "feat: Release v0.10.10-42 (Build 343) $(Get-Date -Format 'yyyy-MM-dd HH:mm')"
